...
#define pwm_base  2100                                                  //Fréquence de travail : 20 kHz, wrap à 6250, là PWM de base à 50% but provisoire
...
static int dif_right, dif_left;                                         //Let us know which way the motor is sup
